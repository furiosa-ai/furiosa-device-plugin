	...
	return &v1.Pod{
		...
		Spec: v1.PodSpec{
			...
			Containers: []v1.Container{
				{
					Name:            "verification-pod",
					Image:           "registry.furiosa.ai/furiosa/furiosa-device-plugin/e2e/verification:latest",
	...
	return &v1.Pod{
		...
		Spec: v1.PodSpec{
			...
			Containers: []v1.Container{
				{
					Name:            "inference-pod",
					Image:           "registry.furiosa.ai/furiosa/furiosa-device-plugin/e2e/inference:latest",
					ImagePullPolicy: v1.PullAlways,
					Resources: v1.ResourceRequirements{
						Limits: v1.ResourceList{
...
daemonSet:
  ...
  tolerations:
    - key: npu
      operator: Exists
  image:
    repository: registry.furiosa.ai/furiosa/furiosa-device-plugin
    tag: latest
    pullPolicy: Always
  resources:
    cpu: 100m
